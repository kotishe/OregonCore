    ...
    // Load playercreate spells
    {
        ...
        else
        {
            ...
            do
            {
                ...
                uint32 spellId = fields[2].GetUInt16();
...
bool ObjectMgr::LoadQuestGreetings()
{
    ...
    QueryResult_AutoPtr result = WorldDatabase.Query("SELECT entry,content_default,content_loc1,content_loc2,content_loc3,content_loc4,content_loc5,content_loc6,content_loc7,content_loc8,Emote,EmoteDelay FROM quest_greeting");
